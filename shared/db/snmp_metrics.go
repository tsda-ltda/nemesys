...
const (
	...
	sqlSNMPMetricsGetByIds = `SELECT metric_id, oid FROM snmp_metrics WHERE metric_id = ANY ($1);`
...
func (c *SNMPMetrics) GetByIds(ctx context.Context, ids []int64) (metrics []models.SNMPMetric, err error) {
