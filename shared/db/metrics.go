...
func (c *Metrics) ExistsIdentAndContainerAndDataPolicy(ctx context.Context, containerId int32, containerType types.ContainerType, dataPolicyId int16, ident string, id int64) (e bool, ce bool, dpe bool, ie bool, err error) {
